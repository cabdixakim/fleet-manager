...
export const sidebarConfig: SidebarGroup[] = [
  {
    ...
    links: [
      ...
      { label: "Clearances",   path: "/clearances",  icon: "shieldCheck", roles: ["admin", "manager", "operations"] },
    ],
  },
  {
    section: "Fleet",
    ...
    links: [
      ...
      { label: "Drivers",         path: "/drivers",        icon: "user",   roles: ["admin", "manager", "operations"] },
      { label: "Subcontractors",  path: "/subcontractors", icon: "users",  fleetHide: "company" },
      { label: "Asset Register",    path: "/assets",                       icon: "barChart2",   roles: ["admin", "manager", "operations"] },
      { label: "Insurance Policies", path: "/company-insurance-policies", icon: "shieldCheck", roles: ["admin", "manager"] },
      { label: "Claims",             path: "/insurance-claims",            icon: "shieldCheck", roles: ["admin", "manager", "operations"] },
    ],
  },
  {
    section: "Finance",
